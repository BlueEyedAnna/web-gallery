...
function animateCSSModeScroll(e) {
    ...
    const d = s > r ? "next" : "prev", c = (e, t) => "next" === d && e >= t || "prev" === d && e <= t, p = () => {
        ...
        let u = r + d * (s - r);
        if (c(u, s) && (u = s), t.wrapperEl.scrollTo({[a]: u}), c(u, s)) return t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.scrollSnapType = "", setTimeout((() => {
...
function elementOffset(e) {
    const t = getWindow(), s = getDocument(), a = e.getBoundingClientRect(), i = s.body,
        r = e.clientTop || i.clientTop || 0, n = e.clientLeft || i.clientLeft || 0,
        l = e === t ? t.scrollY : e.scrollTop, o = e === t ? t.scrollX : e.scrollLeft;
...
function calcDevice(e) {
    ...
    const s = getSupport(), a = getWindow(), i = a.navigator.platform, r = t || a.navigator.userAgent,
        n = {ios: !1, android: !1}, l = a.screen.width, o = a.screen.height, d = r.match(/(Android);?[\s\/]+([\d.]+)?/);
    let c = r.match(/(iPad).*OS\s([\d_]+)/);
    const p = r.match(/(iPod)(.*OS\s([\d_]+))?/), u = !c && r.match(/(iPhone\sOS|iOS)\s([\d_]+)/), m = "Win32" === i;
    let f = "MacIntel" === i;
...
function Observer(e) {
    ...
    const r = [], n = getWindow(), l = function (e, s) {
        void 0 === s && (s = {});
...
function updateSlides() {
    ...
    const a = e.params, {wrapperEl: i, slidesEl: r, size: n, rtlTranslate: l, wrongRTL: o} = e,
        ...
        p = elementChildren(r, `.${e.params.slideClass}, swiper-slide`), u = d ? e.virtual.slides.length : p.length;
    let m = [];
    const f = [], h = [];
    ...
    let y = a.spaceBetween, E = -g, S = 0, x = 0;
    if (void 0 === n) return;
...
function loopFix(e) {
    ...
    if (y && g.forEach((e => {
        ...
        const e = o.slidesGrid[w], t = o.slidesGrid[w - S] - e;
...
function onTouchStart(e) {
    const t = this, s = getDocument(), a = getWindow(), i = t.touchEventsData;
    i.evCache.push(e);
    ...
    const f = n.currentX, h = n.currentY, g = r.edgeSwipeDetection || r.iOSEdgeSwipeDetection,
...
function onTouchMove(e) {
    ...
    d >= 0 && (a.evCache[d] = o);
    const c = a.evCache.length > 1 ? a.evCache[0] : o, p = c.pageX, u = c.pageY;
    ...
    let h = s.isHorizontal() ? m : f, g = s.isHorizontal() ? r.currentX - r.previousX : r.currentY - r.previousY;
    ...
    if (!a.isMoved) {
        if (w && s.loopFix({direction: s.swipeDirection}), a.startTranslate = s.getTranslate(), s.setTransition(0), s.animating) {
...
function onTouchEnd(e) {
    ...
    const v = (u - l[m]) / f, w = m < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
    if (p > i.longSwipesMs) {
...
const events = (e, t) => {
    const s = getDocument(), {params: a, el: i, wrapperEl: r, device: n} = e, l = !!a.nested,
        o = "on" === t ? "addEventListener" : "removeEventListener", d = t;
    i[o]("pointerdown", e.onTouchStart, {passive: !1}), s[o]("pointermove", e.onTouchMove, {
        passive: !1,
        capture: l
    }), s[o]("pointerup", e.onTouchEnd, {passive: !0}), s[o]("pointercancel", e.onTouchEnd, {passive: !0}), s[o]("pointerout", e.onTouchEnd, {passive: !0}), s[o]("pointerleave", e.onTouchEnd, {passive: !0}), (a.preventClicks || a.preventClicksPropagation) && i[o]("click", e.onClick, !0), a.cssMode && r[o]("scroll", e.onScroll), a.updateOnWindowResize ? e[d](n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", onResize, !0) : e[d]("observerUpdate", onResize, !0), i[o]("load", e.onLoad, {capture: !0})
};

function attachEvents() {
    const e = this, t = getDocument(), {params: s} = e;
...
function setBreakpoint() {
    ...
    const l = (n in r ? r[n] : void 0) || e.originalParams, o = isGridEnabled(e, a), d = isGridEnabled(e, l),
        c = a.enabled;
    o && !d ? (i.classList.remove(`${a.containerModifierClass}grid`, `${a.containerModifierClass}grid-column`), e.emitContainerClasses()) : !o && d && (i.classList.add(`${a.containerModifierClass}grid`), (l.grid.fill && "column" === l.grid.fill || !l.grid.fill && "column" === a.grid.fill) && i.classList.add(`${a.containerModifierClass}grid-column`), e.emitContainerClasses()), ["navigation", "pagination", "scrollbar"].forEach((t => {
        const s = a[t] && a[t].enabled, i = l[t] && l[t].enabled;
        s && !i && e[t].disable(), !s && i && e[t].enable()
    }));
    const p = l.direction && l.direction !== a.direction, u = a.loop && (l.slidesPerView !== a.slidesPerView || p);
...
function getBreakpoint(e, t, s) {
    ...
    let a = !1;
    const i = getWindow(), r = "window" === t ? i.innerHeight : s.clientHeight, n = Object.keys(e).map((e => {
...
function moduleExtendParams(e, t) {
    return function (s) {
        ...
        "object" == typeof i && null !== i ? (["navigation", "pagination", "scrollbar"].indexOf(a) >= 0 && !0 === e[a] && (e[a] = {auto: !0}), a in e && "enabled" in i ? (!0 === e[a] && (e[a] = {enabled: !0}), "object" != typeof e[a] || "enabled" in e[a] || (e[a].enabled = !0), e[a] || (e[a] = {enabled: !1}), extend(t, s)) : extend(t, s)) : extend(t, s)
    }
}
...
function Virtual(e) {
    ...
    function d(e) {
        const {slidesPerView: t, slidesPerGroup: a, centeredSlides: i, loop: n} = s.params, {
            addSlidesBefore: l,
            addSlidesAfter: d
        ...
        const C = n ? -u.length : 0, P = n ? 2 * u.length : u.length;
...
function Keyboard(e) {
    ...
    function l(e) {
        ...
        const l = a.keyCode || a.charCode, o = t.params.keyboard.pageUpDown, d = o && 33 === l, c = o && 34 === l,
            p = 37 === l, u = 39 === l, m = 38 === l, f = 40 === l;
        ...
        if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || r.activeElement && r.activeElement.nodeName && ("input" === r.activeElement.nodeName.toLowerCase() || "textarea" === r.activeElement.nodeName.toLowerCase()))) {
            if (t.params.keyboard.onlyInViewport && (d || c || p || u || m || f)) {
                ...
                const a = t.el, i = a.clientWidth, r = a.clientHeight, l = n.innerWidth, o = n.innerHeight,
                    d = elementOffset(a);
    ...
    t.keyboard = {enabled: !1}, s({keyboard: {enabled: !1, onlyInViewport: !0, pageUpDown: !0}}), a("init", (() => {
...
function Mousewheel(e) {
    ...
    function m(e) {
        ...
        if (h >= t.minTranslate() && (h = t.minTranslate()), h <= t.maxTranslate() && (h = t.maxTranslate()), a = !!t.params.loop || !(h === t.minTranslate() || h === t.maxTranslate()), a && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
            ...
            const s = {time: now(), delta: Math.abs(p), direction: Math.sign(p), raw: e};
            d.length >= 2 && d.shift();
...
function Pagination(e) {
    ...
    Object.assign(t.pagination, {
        ...
        }, disable: g, render: m, update: u, init: f, destroy: h
    })
}
...
function Scrollbar(e) {
    ...
    function v(e) {
        const s = t.params.scrollbar, {scrollbar: a, wrapperEl: r} = t, {el: l, dragEl: o} = a;
    ...
    function w(e) {
        const {scrollbar: s, wrapperEl: a} = t, {el: r, dragEl: n} = s;
    ...
    function b(e) {
        const s = t.params.scrollbar, {scrollbar: a, wrapperEl: r} = t, {el: n} = a;
    ...
    function y(e) {
        ...
        if (!i) return;
        const n = i, l = !!a.passiveListeners && {passive: !1, capture: !1},
    ...
    }), t.scrollbar = {el: null, dragEl: null}, a("init", (() => {
    ...
    Object.assign(t.scrollbar, {
        ...
        }, disable: x, updateSize: f, setTranslate: m, init: E, destroy: S
    })
}
...
function Zoom(e) {
    ...
    function h() {
        ...
        const e = c[0].pageX, t = c[0].pageY, s = c[1].pageX, a = c[1].pageY;
    ...
    function w(e) {
        if (!g(e)) return;
        const s = t.params.zoom, a = t.zoom, i = c.findIndex((t => t.pointerId === e.pointerId));
    ...
    function y(e) {
        ...
        const r = (s.scale - o) / (p.maxRatio - t.params.zoom.minRatio), {originX: n, originY: l} = p;
...
function History(e) {
    ...
    const n = e => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
        l = e => {
            ...
            d && d.value === o || (t.params.history.replaceState ? a.history.replaceState({value: o}, null, o) : a.history.pushState({value: o}, null, o))
        }, d = (e, s, a) => {
...
function HashNavigation(e) {
    let {swiper: t, extendParams: s, emit: a, on: i} = e, r = !1;
...
function Autoplay(e) {
    let t, s, {swiper: a, extendParams: i, on: r, emit: n, params: l} = e;
    a.autoplay = {running: !1, paused: !1, timeLeft: 0}, i({
        autoplay: {
            enabled: !1,
            delay: 3e3,
            waitForTransition: !0,
    ...
    let o, d, c, p, u, m, f, h = l && l.autoplay ? l.autoplay.delay : 3e3, g = l && l.autoplay ? l.autoplay.delay : 3e3,
        v = (new Date).getTime;
    ...
    s({
        ...
        freeMode: {
            onTouchStart: function () {
                ...
                }), e.velocities.push({position: s[t.isHorizontal() ? "currentX" : "currentY"], time: now()})
...
function createShadow(e, t, s) {
    const a = "swiper-slide-shadow" + (s ? `-${s}` : ""), i = getSlideTransformEl(t);
...
function EffectFlip(e) {
    ...
    effectInit({
        ...
        setTransition: e => {
            ...
            })), effectVirtualTransitionEnd({swiper: t, duration: e, transformElements: s})
        },
        recreateShadows: () => {
    ...
    effectInit({
        effect: "coverflow", swiper: t, on: a, setTranslate: () => {
            ...
            for (let e = 0, t = a.length; e < t; e += 1) {
                ...
                let u = n ? d * p : 0, m = n ? 0 : d * p, f = -c * Math.abs(p), h = r.stretch;
                "string" == typeof h && -1 !== h.indexOf("%") && (h = parseFloat(r.stretch) / 100 * s);
                let g = n ? 0 : h * p, v = n ? h * p : 0, w = 1 - (1 - r.scale) * Math.abs(p);
    ...
    effectInit({
        ...
        setTranslate: () => {
            ...
            for (let l = 0; l < e.length; l += 1) {
                ...
                let h = 1, g = -a.perSlideRotate * c, v = a.perSlideOffset - .75 * Math.abs(c);
